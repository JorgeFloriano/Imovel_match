...
class PropertyRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'image' => 'nullable|file|mimes:jpeg,jpg,png|max:500',
            'property_images' => 'nullable|array|max:6',
            'property_images.*' => 'file|mimes:jpeg,jpg,png|max:1024',
            ...
            'min_act' => 'nullable|numeric|min:0|max:9999999999',
