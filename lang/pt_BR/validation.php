...
return [
    ...
    'attributes' => [
        ...
        'need_financing' => 'precisa de financiamento',
        'dependents' => 'número de dependentes',
        'profession' => 'profissão',
        'revenue' => 'renda mensal',
        'capital' => 'capital disponível',
        'fgts' => 'saldo de fgts',
        'has_property' => 'já possúi propriedade',
        'compromised_income' => 'comprometimento de renda',
        'region_id' => 'região',
        'selected_regions' => 'regiões selecionadas',
        'type' => 'tipo de imóvel',
        'rooms' => 'quartos',
        'bathrooms' => 'banheiros',
        'suites' => 'suítes',
        'garages' => 'vagas na garagem',
        'delivery_key' => 'previsão de entrega',
        'building_area' => 'área útil',
